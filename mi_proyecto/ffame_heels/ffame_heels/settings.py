"""
Django settings for ffame_heels project.
...
SECRET_KEY = 'django-insecure-1g^8y_$=1!3kll+sl3fsia5=11=-4t!&3*k_%9fne9!gyg5nix'
...
if DEBUG and not USE_MYSQL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('MYSQL_DATABASE', 'ffame_heels_db'),
